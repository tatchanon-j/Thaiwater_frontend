...
$view->option('js-init','graphWaterQualityParam.init(group_Translator,station,name)');
?>

@section('extra_head')
{!! $view->asset('DataTables','DataTables-buttons','parsley','bootstrap-multiselect','Font-Kanit','highcharts','bootstrap-datetimepicker') !!}
{!! $view->resource('js','js/backoffice/analyst/iframe/graph-waterquality-compareparam.js') !!}
@stop
...
<form class="form-horizontal">
    <div class="form-group">
        <div class="col-sm-12">
          <h4 class="text-center" id="graphSelect">{{ trans('frontoffice/home/index.waterquality_graph_title_link') }}{{ trans('backoffice/analyst/analyst.compare_param') }}</h4>
        </div>
    </div>
    <div class="form-group">
        <div class="col-sm-6">
            ...
            <div class="col-sm-8">
                <select class="form-control" name="graphtype" id="graphtype">
                  ...
                  <option value="param" selected>{{ trans('backoffice/analyst/analyst.compare_param') }}</option>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            ...
            <div class="col-sm-8">
                <select class="form-control" name="datatype" id="datatype" multiple="multiple">
                </select>
            </div>
        </div>
    </div>
...
var group_Translator = {
    ...
    'station': '{{ trans("backoffice/analyst/analyst.station") }}',
