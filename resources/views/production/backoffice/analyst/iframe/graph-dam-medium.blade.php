...
$view->option('js-init','graphDamMedium.init(group_Translator,station,dam_size)');
?>

@section('extra_head')
{!! $view->asset('DataTables','DataTables-buttons','parsley','bootstrap-multiselect','Font-Kanit','highcharts','bootstrap-datetimepicker') !!}
{!! $view->resource('js','js/backoffice/analyst/iframe/graph-dam-medium.js') !!}
@stop
...
<form class="form-horizontal">
    <div class="form-group">
        <div class="col-sm-12">
          <h4 class="text-center" id="graphSelect">{{ trans('backoffice/analyst/analyst.graph_dam_medium') }}</h4>
        </div>
    <div class="form-group">
        <div class="col-sm-6">
            ...
            <div class="col-sm-8">
                <select class="form-control" name="graphtype" id="graphtype">
                  ...
                  <option value="medium" selected>{{ trans('backoffice/analyst/analyst.graph_dam_medium') }}</option>
                </select>
            </div>
        </div>
        <div class="col-sm-6">
