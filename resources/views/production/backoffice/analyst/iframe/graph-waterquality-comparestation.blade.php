...
$view->option('js-init','graphWaterQualityStation.init(group_Translator,station,name)');
?>

@section('extra_head')
{!! $view->asset('DataTables','DataTables-buttons','parsley','bootstrap-multiselect','Font-Kanit','highcharts','bootstrap-datetimepicker') !!}
{!! $view->resource('js','js/backoffice/analyst/iframe/graph-waterquality-comparestation.js') !!}
@stop
...
<form class="form-horizontal">
    <div class="form-group">
        <div class="col-sm-12">
          <h4 class="text-center" id="graphSelect">{{ trans('frontoffice/home/index.waterquality_graph_title_link') }}{{ trans('backoffice/analyst/analyst.compare_station') }}</h4>
        </div>
    </div>
    <div class="form-group">
        <div class="col-sm-6">
            ...
            <div class="col-sm-8">
                <select class="form-control" name="graphtype" id="graphtype">
                  <option value="station" selected>{{ trans('backoffice/analyst/analyst.compare_station') }}</option>
