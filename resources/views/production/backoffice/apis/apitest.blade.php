...
<div class="form-group">
        <label for="test-service">Service URL</label> Prefix : <span id="test-api-url-prefix"></span>
		<input id="test-service" class="form-control" placeholder="/thaiwater30/backoffice/metadata/agency" />
...
{!! $view->resource('js','js/backoffice/apis/apitest.js') !!}
