...
$view->option('page_name', trans('backoffice/tools/manage_two.page_name'));
?>

{!! $view->resource('theme-css','css/backoffice/tools/manage_two.css') !!}
{!! $view->asset('DataTables','DataTables-buttons','parsley','bootstrap-multiselect','JsonHelper') !!}
{!! $view->resource('js','js/backoffice/tools/manage_two.js') !!}
@stop
...
<div class="data-filters">
    <form class="form-row">
        <div class="form-group row col-sm-4">
            <label class="col-sm-4 form-control-label text-sm-right"><span
        ...
        <div class="form-group row col-sm-4">
            <label class="col-sm-4 form-control-label text-sm-right"><span
                    class="color-red">*</span>ชื่อผู้ใช้</label>
            <div class="col-sm-8">
                <select class="form-control">
                    <option>ผู้ใช้ 1</option>
                    <option>ผู้ใช้ 2</option>
                    <option>ผู้ใช้ 3</option>
                    <option>ผู้ใช้ 4</option>
                    <option>ผู้ใช้ 5</option>
                </select>
            </div>
        </div>
    </form>
