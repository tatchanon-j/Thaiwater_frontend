...
//$item = implode(" ",$locale_switcher);
//echo '<script>console.log("'.$locale_switcher.'")</script>';
...
<header class="main-header">
	...
	<nav class="navbar" role="navigation" style="padding: 0;height:51px">
		<a href="#" style="height:51px" class="sidebar-toggle" data-toggle="offcanvas"
		role="button"> <span class="sr-only">Toggle navigation</span> <span
		class="icon-bar"></span> <span class="icon-bar"></span> <span
		class="icon-bar"></span> <span class="site-name">{{trans('/site.name')}}</span>
	</a>
	<div class="navbar-custom-menu form-row">
		...
		<li class="dropdown user user-menu"><a href="#"
			class="dropdown-toggler" data-toggle="dropdown"><i
				...
				<ul class="dropdown-menu">
					...
					<li class="user-footer">
						<div class="text-center">
							<button id="btn-editprofile" type="button" class="btn btn-default btn-flat pull-left hidden-xs"  data-toggle="modal" data-target="#dlgEditProfile">{{ trans('/master.profile')}}</button>
...
<div id="dlgEditProfile" class="modal fade" role="dialog" style="display:none">
	<div class="modal-dialog modal-lg">
			...
			<div class="modal-body">
				<form id="dlgEditProfile-form" class="form-row" role="form" enctype="multipart/form-data">
					<div class="col-sm-3">
						<div class="form-group row">
							<div class="upload-button form-group row" style="margin-left:auto; margin-right:auto;">
								<a href="#" data-toggle="tooltip" title="{{trans('/master.edit_profile_change_picture')}}">
					...
					<div class="col-sm-9">
						<!-- email -->
						<div class="form-group row">
							<label  class="col-sm-3 form-control-label text-sm-right">{{trans('master.edit_profile_account')}}:
							</label>
							<div class="col-sm-9">
						...
						<!-- name & surname -->
						<div class="form-group row">
							<label class="col-sm-3 form-control-label text-sm-right"><span class="color-red">*</span>{{trans('master.edit_profile_full_name')}}:</label>
							<div class="col-sm-9">
								<input type="text" class="form-control"  id="dlgEditProfile-full_name" name="full_name"
								value="{{ $account_info->full_name or ''}}"
								data-parsley-required>
							</div>
						</div>
						<!-- Old password -->
						<div class="form-group row grp-pass">
							<label  class="col-sm-3 form-control-label text-sm-right">{{ trans('master.old_password') }}:</label>
							<div class="col-sm-9 old-pass">
								...
								<li class="parsley-custom-error-message">กรุณากรอกรหัสผ่านเดิม</li>
							</ul> -->
						</div>
					</div>
					<!-- New password -->
					<div class="form-group row grp-pass">
						<label  class="col-sm-3 form-control-label text-sm-right">{{ trans('master.new_password') }}:</label>
						<div class="col-sm-9 new-pass">
							<input type="password" class="form-control"  id="dlgEditProfile-newpassword" name="newpassword"
					...
					<!-- Repassword -->
					<div class="form-group row grp-pass">
						<label  class="col-sm-3 form-control-label text-sm-right">{{ trans('master.confirm_new_password') }}:</label>
						<div class="col-sm-9 renew-pass">
							...
							data-parsley-equalto="#dlgEditProfile-newpassword"
							data-parsley-group="chpasswd"
							>
						</div>
					</div>
		...
		<div class="modal-footer">
			...
			<button type="button" class="btn btn-primary"	id="dlgEditProfile-btn-save">{{trans('/master.btn_save')}}</button>
		</div>
