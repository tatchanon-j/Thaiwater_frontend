...
$view->option('page_name', trans('backoffice/metadata/metadata.page_name'));
?>

{!! $view->asset('DataTables','DataTables-buttons','parsley','bootstrap-multiselect','bootstrap-datepicker','select2') !!}
{!! $view->resource('js','js/backoffice/metadata/metadata.js') !!}
    ...
    <form class="form-inline justify-content-center">
        ...
        <div class="row">
            <div class="form-group col-sm-6">
                <label for="filter_agency" class="col-sm-4 control-label ">{{ trans('/backoffice/metadata/metadata.agency') }}:</label>
        ...
        <div class="form-group col-sm-6" style="margin-bottom : 10px">
                <label for="filter_hydro" class="col-sm-4 control-label ">{{ trans('/backoffice/metadata/metadata.hydro') }}:</label>
                <div class="col-sm-8 fil_agency">
        ...
        <div class="form-group col-sm-6">
        <label for="" class="col-sm-4 control-label">{{ trans('/backoffice/metadata/metadata.category') }}:</label>
                <div class="col-sm-8">
         ...
         <div class="form-group col-sm-6">
         <label for="" class="col-sm-4 control-label">{{ trans('/backoffice/metadata/metadata.subcategory') }}:</label>
                <div class="col-sm-8">
        ...
        <table id="tbl-metadata" class="display admin-datatables" width="100%">
            <thead>
                <tr>
                    ...
                    <th>{{trans('backoffice/metadata/metadata.col_hydro')}}</th>
...
<form id="form" data-parsley-validate="" class="form-horizontal form_metadata" role="form" style="display:none;">
    ...
    <div class="form-group col-md-12">
        <label for="language-form" class="col-md-2 control-label"><b>{{trans('backoffice/metadata/metadata.language')}}:</b></label>
        <div class="col-md-10">
    ...
    <div class="metadata-th">
        ...
        <div class="form-inline">
            ...
            <div class="col-md-8">
                    <select name="agency" id="form-agency" class="form-control"
                data-parsley-required data-parsley-error-message="{{trans('master.msg_err_data_null')}}"></select>    
                </div>
                <div class="col-sm-1">
            ...
            <div class="col-md-8 frm_hydro">
                <select name="hydro" id="form-hydro" multiple="multiple" class="form-control"
            ...
            <div class="form-group col-md-12" style="margin-bottom : 10px">
                ...
                <div class="col-md-8">
                        <input type="text" class="form-control" id="form-agency_name" placeholder=""
                            data-parsley-required data-parsley-error-message="{{trans('master.msg_err_require')}}" style="width :100%">
                </div>
                    <span>
            ...
            <div class="col-md-8">
                <input type="" class="form-control" id="form-service_name" placeholder=""
                data-parsley-required data-parsley-error-message="{{trans('master.msg_err_require')}}" style="width :100%">
            </div>
            <span>
                <i class='fa fa-info-circle' aria-hidden='true'  data-toggle="tooltip" data-placement="top"
        ...
        <div class="form-inline">
            ...
            <div class="col-md-8">
                <textarea  class="form-control" rows="2" id="form-description" placeholder=""  style="width :100%"></textarea>
            </div>
            <span>
                <i class='fa fa-info-circle' aria-hidden='true'  data-toggle="tooltip" data-placement="top"
        ...
        <div class="form-inline">
            ...
            <div class="col-md-8">
                <div class="input-group date">
                    <input id="form-agency_store_date" data-provide="datepicker" data-date-format="yyyy-mm-dd" type="text" class="form-control" placeholder="YYYY-MM-DD"
                    data-parsley-error-message="{{trans('master.msg_err_require')}}" data-parsley-errors-container="#erroraAencystoredate">
            ...
            <div class="col-sm-8">
                <div class="input-group date">
                    <input id="form-start_data_date" data-provide="datepicker" data-date-format="yyyy-mm-dd" type="text" class="form-control" placeholder="YYYY-MM-DD"
                    data-parsley-error-message="{{trans('master.msg_err_require')}}"  data-parsley-errors-container="#erroraDatedata">
                    <div class="input-group-append">
                        <span class="input-group-text"><i class="fa fa-calendar" aria-hidden="true"></i></span>
                    </div>
                </div>
            ...
            <div class="col-sm-8">
                <div class="input-group date">
                    <input id="form-metadata_receive_date" data-provide="datepicker" data-date-format="yyyy-mm-dd" type="text" class="form-control" placeholder="YYYY-MM-DD"
                    data-parsley-error-message="{{trans('master.msg_err_require')}}"  data-parsley-errors-container="#errorMetaDataDate">
                    <div class="input-group-append">
                        <span class="input-group-text"><i class="fa fa-calendar" aria-hidden="true"></i></span>
                    </div>
                </div>
        ...
        <label class="col-sm-12"><b>4.{{trans('backoffice/metadata/metadata.contact')}}</b></label>
                <div class="form-inline">
                    <div class="form-group col-md-12">
                         <label for="form-contact" class="col-sm-3 control-label">{{trans('backoffice/metadata/metadata.contact')}}:</label>
                            <div class="col-sm-8">
                                <textarea id="form-contact" class="form-control" rows="4" placeholder='' style = "width :100%"></textarea>
                            </div>
                        <span class="col-sm-1">
                        <i class='fa fa-info-circle' aria-hidden='true'  data-toggle="tooltip" data-placement="top"
        ...
        <label class="col-sm-12"><b>5.{{trans('backoffice/metadata/metadata.tag')}}</b></label>
                <div class="form-inline">
                    <div class="form-group col-md-12">
                         <label for="form-tag" class="col-sm-3 control-label">{{trans('backoffice/metadata/metadata.tag')}}:</label>
                            <div class="col-md-8">
        ...
        <label class="col-sm-12"><b>6.{{trans('backoffice/metadata/metadata.connection_format')}}</b></label>
                <div class="form-inline">
                    <div class="form-group col-md-12">
                    <label for="" class="col-sm-3 control-label">{{trans('backoffice/metadata/metadata.connection_format')}}:</label>
                        <div class="col-md-1">
                                <div class="radio">
        ...
        <label class="col-sm-12"><b>8.{{trans('backoffice/metadata/metadata.data_unit').trans('backoffice/metadata/metadata.data_unit_desc')}}</b></label>
                <div class="form-inline">
                    <div class="form-group col-md-12">
                    <label for="form-data_unit" class="col-sm-3 control-label">{{trans('backoffice/metadata/metadata.data_unit')}}:</label>
                            <div class="col-sm-8">
        ...
        <label class="col-sm-12"><b>9.{{trans('backoffice/metadata/metadata.frequency')}}</b></label>
            ...
            <div class="col-sm-2">
                ...
                data-parsley-required data-parsley-error-message="{{trans('master.msg_err_data_null')}}" style="width:100%"></select>
            </div>
            <div class="col-sm-1 icon-add">
                <a href="javascript:void(0)" class="add-group-frequency"><i class="fa fa-plus-circle" aria-hidden="true"></i></a>
            </div>
        </div>
        ...
        <label class="col-sm-12"><b>10.{{trans('backoffice/metadata/metadata.metadata')}}</b></label>
            ...
            <div class="col-sm-8" style="margin-bottom:10px">
                <select id="form-metadata_status" class="form-control"
                data-parsley-required data-parsley-error-message="{{trans('master.msg_err_data_null')}}" style="width:100%"></select>
            </div>
            ...
            <div class="col-sm-8" style="margin-bottom:10px">
                <select id="form-dataformat" class="form-control"
                data-parsley-required data-parsley-error-message="{{trans('master.msg_err_data_null')}}" style="width:100%"></select>
            </div>
            ...
            <div class="col-sm-6" style="margin-bottom:10px">
                <input type="number" min="1" class="form-control" id="form-convertfrequency"
                data-parsley-required data-parsley-error-message="{{trans('master.msg_err_require')}}" style="width:100%">
            </div>
        ...
        <label class="col-sm-12"><b>11.{{trans('backoffice/metadata/metadata.service_method')}}</b></label>
                <div class="form-inline">
                    <div class="form-group col-md-12">
                    <label for="form-service_method" class="col-sm-3 control-label">{{trans('backoffice/metadata/metadata.service_method')}}:</label>
                        <div class="col-sm-8">
        ...
        <label class="col-sm-12"><b>12.{{trans('backoffice/metadata/metadata.other')}}</b></label>
            ...
            <div class="col-sm-7" style="margin-bottom : 10px">
                <input type="number" min="1" class="form-control" id="form-update_plan"
                data-parsley-required data-parsley-error-message="{{trans('master.msg_err_require')}}" style="width : 100%">
            </div>
            ...
            <label for="form-law" class="col-sm-3 control-label">{{trans('backoffice/metadata/metadata.law')}}:</label>
            <div class="col-sm-8" style="margin-bottom : 10px">
            ...
            <label for="form-remark" class="col-sm-3 control-label">{{trans('backoffice/metadata/metadata.remark')}}:</label>
            <div class="col-sm-8" style="margin-bottom : 10px">
        ...
        <label class="col-sm-12 history_log"><b>13.{{trans('backoffice/metadata/metadata.history_log')}}</b></label>
            ...
            <div class="form-group col-sm-12">
                <label for="form-history" class="col-sm-3 control-label">{{trans('backoffice/metadata/metadata.history')}}:</label>
                <div class="col-sm-8">
    ...
    <div class="form-inline">
        ...
        <div class="form-group col-md-12">
            <label for="form-agency_name-en" class="col-sm-3 control-label">{{trans('backoffice/metadata/metadata.agency_name-en')}}:</label>
            <div class="col-sm-8">
        ...
        <div class="form-group col-md-12">
            <label for="form-service_name-en" class="col-sm-3 control-label">{{trans('backoffice/metadata/metadata.service_name-en')}}:</label>
            <div class="col-sm-8">
        ...
        <div class="form-group col-md-12">
            <label for="form-description-en" class="col-sm-3 control-label">{{trans('backoffice/metadata/metadata.description-en')}}:</label>
            <div class="col-sm-8">
                <textarea  class="form-control" rows="4" id="form-description-en" placeholder="" style="width:100%"></textarea>
            </div>
        </div>
        <div class="form-group col-md-12">
            <label for="form-tag-en" class="col-sm-3 control-label">{{trans('backoffice/metadata/metadata.tag-en')}}:</label>
            <div class="col-sm-8">
    ...
    <div class="form-inline">
        <div class="col-md-offset-4 col-sm-8 err-form"></div>
        <div class="form-group col-md-12">
            <label for="form-agency_name-jp" class="col-sm-3 control-label">{{trans('backoffice/metadata/metadata.agency_name-jp')}}:</label>
            <div class="col-sm-8">
        ...
        <div class="form-group col-md-12">
            <label for="form-service_name-jp" class="col-sm-3 control-label">{{trans('backoffice/metadata/metadata.service_name-jp')}}:</label>
            <div class="col-sm-8">
        ...
        <div class="form-group col-md-12">
            <label for="form-description-jp" class="col-sm-3 control-label">{{trans('backoffice/metadata/metadata.description-jp')}}:</label>
            <div class="col-sm-8">
                <textarea  class="form-control" rows="4" id="form-description-jp" placeholder="" style="width:100%"></textarea>
            </div>
        </div>
        <div class="form-group col-md-12">
            <label for="form-tag-jp" class="col-sm-3 control-label">{{trans('backoffice/metadata/metadata.tag-jp')}}:</label>
            <div class="col-sm-8">
    ...
    <div class="text-center">
        ...
        <button id="form-close-btn" type="button" class="btn btn-default" data-dismiss="modal">{{ trans('/master.btn_cancel') }}</button>
    </div>
</form>
        <div id="master-group-frequency" class="hidden delete-text form-group col-md-12" hidden style="padding-left:0;padding-right:0">
                    ...
                    <label for="form-frequency" class="col-sm-3 control-label">
                            ...
                            <div class="col-sm-6">
                                <input type="number" name="form-frequency" min="1" class="form-control"
                                data-parsley-required data-parsley-error-message="{{trans('master.msg_err_require')}}" style="width : 100%">
                            </div>
                             <div class="col-sm-2">
                                <select name="form-frequency_unit" class="form-control"
                                data-parsley-required data-parsley-error-message="{{trans('master.msg_err_data_null')}}" style="width : 100%">
                                </select>
                            </div>
                            <div class="col-sm-1 icon-add">
