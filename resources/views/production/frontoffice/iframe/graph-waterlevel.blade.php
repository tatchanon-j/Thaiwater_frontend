...
@section('extra_head')
{!! $view->asset('DataTables','DataTables-buttons','parsley','bootstrap-multiselect','Font-Kanit','highcharts-latest','select2') !!}
...
<form class="form-horizontal">
    <div class="form-group form-inline">
        <div class="col-sm-6 form-inline">
            <label for="" class="col-sm-4 control-label justify-content-end">{{ trans('frontoffice/iframe/iframe.province') }}</label>
            <div class="col-sm-8">
        ...
        <div class="col-sm-6 form-inline">
            <label for="" class="col-sm-4 control-label justify-content-end">{{ trans('frontoffice/iframe/iframe.station') }}</label>
            <div class="col-sm-8">
                <select class="form-control" name="id" id="id" style="width:-webkit-fill-available">
                </select>
            </div>
        </div>
    </div>
