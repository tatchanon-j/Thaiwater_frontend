<!DOCTYPE html>
<!--
Template Name: warroom

Author: phithakkhet@haii.or.th
...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{ asset('resources/themes/warroom/layouts/layout2/css/layout.css') }}" rel="stylesheet">
    ...
    <!-- END HEAD -->
<body class="page-header-fixed page-sidebar-closed-hide-logo bg-image">
        ...
        <script src="{{ asset('vendor/bower_components/numeral/min/numeral.min.js') }}"></script>
