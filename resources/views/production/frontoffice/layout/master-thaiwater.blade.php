...
<body class="hold-transition skin-blue-light">
    <div class="wrapper">
        @include('frontoffice/layout/_main-header-thaiwater')
        <div class="content-wrapper">
            <div class="row">
                <div class="col-sm-1"></div>
                <div class="col-sm-11">
                    <section class="text-right" id="content-header">
        ...
        <footer class="main-footer">
            ...
            <div class="col-md-6 text-left">คลังข้อมูลน้ำและภูมิอากาศแห่งชาติ</div>
