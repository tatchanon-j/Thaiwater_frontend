...
<header class="main-header-lightblue flex-md-row" id="main-header">
    <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse-1">
            <ul class="navbar-nav ml-auto">
                ...
                @if ( isset($m['href']) )
                <li class="nav-item {!! ($m['href'] == $current_url)? 'active':'' !!}">
                ...
                <li class="nav-item dropdown username user user-menu ">
                    <a class="" data-toggle="dropdown">
                        <i class="fa fa-user"></i>
                        <span class="hidden-xs"> {{ $account_info->full_name or ''}}</span>
                    </a>
                ...
                <li class="user user-menu nav-item">
                    <a href="javascript:apiService.logout('{{ $api->getLogoutToken() }}')" class=" pull-right">
                        ...
                        <span class="hidden-xs">{{trans('/master.logout')}}</span>
                    </a>
                </li>
                @endif
            </ul>
