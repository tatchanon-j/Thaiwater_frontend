...
evts.init = function(translator) {
  ...
  ctrl.on('click', 'i.btn-repeat', evts.resetEvent)
...
evts.renderResetButtons = function(row, type, set, meta) {
	var s = '<i class="btn btn-repeat" data-row="'+ meta.row +'" title="' + evts.translator['btn_reset']+ '"></i>'
...
/**
 * Get index cell on data table to reset
 */
evts.resetEvent = function(){
